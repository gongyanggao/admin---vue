    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <router-link tag="li" :to="{ name: 'ChartExample' }"><a href=""><i class="fa fa-circle-o"></i>ChartJS</a></router-link>
            <router-link tag="li" :to="{ name: 'ChartExample1' }"><a href=""><i class="fa fa-circle-o"></i>ChartJS1</a></router-link>
